...
sourcesIndex["hermit_abi"] = {"name":"","dirs":[{"name":"net","files":["bindings.rs","event.rs","mod.rs"]}],"files":["bindings.rs","io.rs","lib.rs","tcplistener.rs","tcpstream.rs"]};
sourcesIndex["hermit_sys"] = {"name":"","dirs":[{"name":"net","dirs":[{"name":"socket","files":["event.rs","tcp.rs","waker.rs"]}],"files":["device.rs","executor.rs","mod.rs","nic.rs","poll.rs","socket.rs","socket_map.rs","waker.rs"]}],"files":["cmath.rs","lib.rs"]};
...
sourcesIndex["tcp_echo"] = {"name":"","files":["main.rs"]};
sourcesIndex["tcp_server"] = {"name":"","files":["main.rs"]};
